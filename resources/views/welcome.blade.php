                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                <img src="{{ asset('img/icons/sheets.png') }}" alt="levels">
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="/character/all" class="underline text-gray-900 dark:text-white">Feuilles personnages</a></div>
                            </div>
